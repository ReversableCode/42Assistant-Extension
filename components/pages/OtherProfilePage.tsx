      ...
      <div className="bg-white dark:bg-primary pb-4 shadow-xl max-w-sm relative">
        <div className="w-full h-24 relative">
          <button
            ...
            className="absolute top-2 left-2 p-1.5 rounded-md flex items-center justify-center focus:outline-none bg-primary bg-opacity-50 hover:bg-opacity-70 z-20"
          >
        ...
        <div className="pt-14 px-4 relative flex flex-col z-10">
          <ImageFallback
            onClick={() => window.open(`https://profile.intra.42.fr/users/${profile.login}`, "_blank")}
